...
public class RangeTest {
    ...
    @Test
    public void testShiftAllowsZeroCrossing() {
        Range base = new Range(1.0, 3.0);
        double delta = 2.0;
        boolean allowZeroCrossing = true;
       Range expected = new Range(3.0, 5.0); // both bounds shifted by delta
    ...
    @Test
    public void testShiftPreventsZeroCrossing() {
        Range base = new Range(1.0, 3.0);
        double delta = -2.0;
        boolean allowZeroCrossing = false;
        Range expected = new Range(0.0, 1.0); // shifted but clipped at 0.0 to prevent crossing
    ...
    @Test
    public void testShiftWithZeroCrossingFromNegativeToPositive() {
        Range base = new Range(-3.0, -1.0);
        double delta = 5.0;
        boolean allowZeroCrossing = true;
        Range expected = new Range(2.0, 4.0); // both bounds shifted to positive
    ...
    @Test
    public void testShiftFromNegativeToPositivePreventingZeroCrossing() {
        Range base = new Range(-3.0, -1.0);
        double delta = 5.0;
        boolean allowZeroCrossing = false;
        Range expected = new Range(0.0, 0.0); // shifted but clipped at 0.0
    ...
    @Test
    public void testShiftWithZeroCrossingFromPositiveToNegative() {
        Range base = new Range(1.0, 3.0);
        double delta = -5.0;
        boolean allowZeroCrossing = true;
        Range expected = new Range(-4.0, -2.0); // both bounds shifted to negative
    ...
    @Test
    public void testShiftFromPositiveToNegativePreventingZeroCrossing() {
        Range base = new Range(1.0, 3.0);
        double delta = -5.0;
        boolean allowZeroCrossing = false;
        Range expected = new Range(0.0, 0.0); // shifted but clipped at 0.0
    ...
    @Test
    public void testExpandToIncludeShouldHandleNullRangeAndNegativeValue() {
        Range range = null;
        double value = -5;

        Range result = Range.expandToInclude(range, value);

        assertEquals(new Range(value, value), result);
    }

    @Test
    public void testExpandToIncludeShouldHandleNullRangeAndZeroValue() {
        Range range = null;
        double value = 0;
    ...
    @Test
    public void testExpandToIncludeShouldNotChangeRangeWhenValueEqualsLowerBound() {
    ...
    @Test
    public void testExpandToIncludeShouldNotChangeRangeWhenValueEqualsUpperBound() {
        Range range = new Range(2, 6);
        double value = 6;
    ...
    @Test
    public void testExpandToIncludeShouldExpandToLowerBoundWithNegativeValue() {
        Range range = new Range(1, 5);
        double value = -3;

        Range result = Range.expandToInclude(range, value);

        assertEquals(new Range(value, 5), result);
    }

    @Test
    public void testExpandToIncludeShouldExpandToUpperBoundWithLargerPositiveValue() {
        Range range = new Range(1, 5);
        double value = 10;

        Range result = Range.expandToInclude(range, value);

        assertEquals(new Range(1, value), result);
    }

    @Test
    public void testExpandToIncludeShouldNotChangeRangeWithValueInsideRange() {
        Range range = new Range(1, 5);
        double value = 3;
    ...
    // Test with a range where lower and upper bounds are the same
    @Test
    public void testExpandToIncludeShouldExpandRangeWithIdenticalBounds() {
        Range range = new Range(5, 5);
        double value = 7;

        Range result = Range.expandToInclude(range, value);

        assertEquals(new Range(5, value), result);
    }

    // Test with a range where lower and upper bounds are the same and value is less than the bounds
    @Test
    public void testExpandToIncludeShouldExpandRangeWithIdenticalBoundsAndLowerValue() {
        Range range = new Range(5, 5);
        double value = 2;
    ...
    @Test
    public void testCombineUpperBoundWhenFirstHigherThanSecond() {
        Range range1 = new Range(1, 10);
        Range range2 = new Range(2, 5);
        Range actual = Range.combine(range1, range2);
        assertEquals("The combined range should have the upper bound from the first range when it is higher",
                     10, actual.getUpperBound(), 0.0000001);
    }

    @Test
    public void testCombineUpperBoundWhenSecondHigherThanFirst() {
        Range range1 = new Range(1, 3);
        Range range2 = new Range(2, 6);
        Range actual = Range.combine(range1, range2);
        assertEquals("The combined range should have the upper bound from the second range when it is higher",
                     6, actual.getUpperBound(), 0.0000001);
    }
    
    
    
    @Test
    public void testCombineShouldReturnCombinedRangesWhenBothNonNull() {
        Range range1 = new Range(1, 3);
        Range range2 = new Range(2, 5);
        Range expected = new Range(1, 5);
        Range actual = Range.combine(range1, range2);
        assertEquals("The combine method should return a combined range when both input ranges are non-null",
                     expected, actual);
    }

    @Test
    public void testCombineShouldNotReturnSecondRangeWhenFirstRangeNonNull() {
        Range range1 = new Range(1, 3);
        Range range2 = new Range(2, 5);
        Range result = Range.combine(range1, range2);
        assertNotSame("The combine method should not return the second range when the first range is non-null",
                      range2, result);
    }
    ...
    public void testHashCodeConsistency() {
        ...
        // Consistency: calling hashCode multiple times should return the same value
    ...
    public void testHashCodeEquality() {
        ...
        // Equality: equal objects must have the same hashCode
    ...
    public void testHashCodeInequality() {
        ...
        // Inequality: it's preferable (but not required) for different objects to have different hashCodes
    ...
    public void testHashCodeDifferentLower() {
        ...
        // Different lower bounds should (preferably) yield a different hashCode
        assertNotEquals(range1.hashCode(), range2.hashCode());
    }
    ...
    public void testHashCodeDifferentUpper() {
        ...
        // Different upper bounds should (preferably) yield a different hashCode
        assertNotEquals(range1.hashCode(), range2.hashCode());
    }
